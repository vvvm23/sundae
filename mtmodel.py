...
class Transformer(HelperModule):
    ...
    def sample_step(self,
            src: torch.Tensor, src_len: int,
            tgt: torch.Tensor, tgt_len: int = None,
        ...
        if not exists(src_h):
            ...
            _, tgt_len = self.len_predictor(src_v) # paper has a typo for this part

            # don't downsample tgt_len as we are now using predicted tgt_len
